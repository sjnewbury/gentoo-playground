...
IUSE="examples gles2 gstreamer +introspection +opengl +pango test wayland kms" # doc profile
...
src_prepare() {
#	epatch "${FILESDIR}/0004-Update-cogl.symbols-and-cogl-path.symbols.patch"
#	epatch "${FILESDIR}/0010-cogl-winsys-egl-kms-Call-swap-notify-handler-even-wh.patch"
#	epatch "${FILESDIR}/0014-Use-the-EGL_KHR_surfacless_context-extension.patch"
#	epatch "${FILESDIR}/0008-framebuffer-Fix-linkage-from-C-applications.patch"
#	epatch "${FILESDIR}/0011-atlas-texture-Keep-reference-on-potential-destinatio.patch"
#	epatch "${FILESDIR}/0009-cogl-winsys-egl-kms-Never-set-EGL_PLATFORM.patch"
#	epatch "${FILESDIR}/0013-Add-a-COGL_EXT_IN_GLES3-option-to-specify-extensions.patch"
