...
IUSE="+alsa amr bindist coreaudio debug doc examples +filters g726 g729 gsm ilbc
	libav ntp-timestamp opengl opus +ortp oss pcap portaudio pulseaudio sdl
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PN}-2.11.0-v4l-automagic.patch" \
		"${FILESDIR}/${PN}-2.11.0-underlinking.patch" \
		"${FILESDIR}/${PN}-2.11.0-tests.patch" \
		"${FILESDIR}/${PN}-2.11.0-xxd.patch"
