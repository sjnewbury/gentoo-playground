...
SLOT="1.0"
IUSE="debug doc gtk +introspection test wayland egl +X" # evdev tslib
...
RDEPEND="
	...
	wayland? ( dev-libs/wayland >=dev-libs/libinput-0.3.0 )
...
src_prepare() {
	epatch "${FILESDIR}/0001-device-manager-xi2-use-allocation-for-clamping.patch"
	epatch "${FILESDIR}/0002-evdev-Used-floating-point-instead-of-fixed-point-num.patch"
	epatch "${FILESDIR}/0003-evdev-Follow-libinput-enum-rename.patch"
	epatch "${FILESDIR}/0004-evdev-Add-clutter_evdev_warp_pointer.patch"
