...
cpu_flags_x86_ssse3 cpu_flags_x86_sse3 cpu_flags_x86_sse2 cpu_flags_x86_mmx
cpu_flags_x86_avx cpu_flags_x86_avx512 cpu_flags_x86_avx2"

PATCHES=(
	"${FILESDIR}"/${PN}-1.0.10-cpuflags.patch
	"${FILESDIR}"/${PN}-1.0.16-more-cpuflags.patch
)
...
src_configure() {
	...
	econf \
		...
		$(use_enable cpu_flags_x86_avx512 avx512f) \
