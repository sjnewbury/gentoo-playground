...
inherit bash-completion-r1 linux-info systemd user readme.gentoo toolchain-funcs vala virtualx udev eutils versionator rpm multilib-minimal

F_REL=fc21
F_PKG_REV=$(get_version_component_range 5)
F_PKG_REV=${F_PKG_REV/p}

MY_PV=$(get_version_component_range 1-4)
#F_SNAPSHOT=$(get_version_component_range 5)
#F_SNAPSHOT=${F_SNAPSHOT/pre/git}
F_SNAPSHOT=git20140609

DESCRIPTION="Universal network configuration daemon for laptops, desktops, servers and virtualization hosts"
HOMEPAGE="http://projects.gnome.org/NetworkManager/"

SRC_URI="https://dl.fedoraproject.org/pub/fedora/linux/development/rawhide/source/SRPMS/n/NetworkManager-${MY_PV}-${F_PKG_REV}.${F_SNAPSHOT}.${F_REL}.src.rpm"
...
COMMON_DEPEND="
	...
	>=net-libs/libndp-1.2[${MULTILIB_USEDEP}]
	>=virtual/udev-165
