...
RDEPEND="dev-lang/php[cli,gd,pcntl,simplexml,ssl]
	sys-process/time
...
src_unpack() {
	...
	sed -i -e "s,^#\(export PTS_DIR=\)\`pwd\`,\1\"/usr/share/${PN}\"," ${PN}
}
...
src_install() {
	...
	fperms -R a+x /usr/share/${PN}/pts-core/external-test-dependencies/scripts/
