...
src_prepare() {
	...
	epatch "${FILESDIR}/enable_vaapi_on_linux-49.diff"
	epatch "${FILESDIR}/${PN}-49.0.2623.0-restore_kDefaultTintFrameInactive.patch"
	epatch "${FILESDIR}/fix-gtk3-build.patch"
	epatch "${FILESDIR}/disable-openh264.diff"
	epatch "${FILESDIR}/issue1742293002_20001.diff"
	epatch_user
