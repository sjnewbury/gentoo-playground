...
IUSE="cups gn gnome gnome-keyring gtk3 +hangouts kerberos neon pic +proprietary-codecs pulseaudio selinux +system-ffmpeg +tcmalloc widevine opencl"
...
src_prepare() {
	...
	epatch "${FILESDIR}/enable_vaapi_on_linux-53.diff"
	epatch "${FILESDIR}/fix-gtk3-build.patch"
	epatch "${FILESDIR}/disable-openh264.diff"
#	epatch "${FILESDIR}/gn-using-system-icu-53.patch"
#	epatch "${FILESDIR}/${PN}-webcl.patch"
#	epatch "${FILESDIR}/${PN}-webcl-enable.patch"
...
src_configure() {
	...
	myconf_gn+=" enable_webcl=$(usex opencl true false)"
