...
MOZ_HTTP_URI=""
EGIT_REPO_URI=https://github.com/stransky/gecko-dev.git

MOZCONFIG_OPTIONAL_GTK3=1
MOZCONFIG_OPTIONAL_WIFI=1
MOZCONFIG_OPTIONAL_JIT="enabled"

inherit check-reqs flag-o-matic toolchain-funcs eutils gnome2-utils mozconfig-v6.45 pax-utils fdo-mime autotools virtualx mozlinguas git-r3
...
src_prepare() {
	# Apply our patches
	[[ -d "${WORKDIR}/firefox" ]] && eapply "${WORKDIR}/firefox"
	[[ -d "${FILESDIR}/${MOZ_PV}" ]] && eapply "${FILESDIR}/${MOZ_PV}"
