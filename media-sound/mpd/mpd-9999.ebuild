...
EAPI=5
inherit eutils flag-o-matic linux-info multilib readme.gentoo systemd user autotools git-r3
...
IUSE="adplug +alsa ao audiofile bzip2 cdio +curl debug faad +fifo +ffmpeg flac
	...
	twolame unicode vorbis wavpack wildmidi zeroconf zip soxr realtime"
...
src_prepare() {
	...
	if has_version dev-libs/libcdio-paranoia; then
		sed -i \
			...
			src/input/plugins/CdioParanoiaInputPlugin.cxx || die
	fi
...
src_configure() {
	...
	use realtime && mpdconf+=" --enable-rtopt"
