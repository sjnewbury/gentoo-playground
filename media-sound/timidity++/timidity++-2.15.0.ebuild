...
IUSE="alsa ao emacs flac gtk jack motif nas ncurses oss pulseaudio selinux slang speex tk vorbis X"
...
DEPEND="
	...
	pulseaudio? ( >=media-sound/pulseaudio-10 )
