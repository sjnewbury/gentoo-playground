...
inherit autotools eutils linux-info flag-o-matic multilib-minimal python-any-r1 systemd virtualx user git-r3

DESCRIPTION="A message bus system, a simple way for applications to talk to each other"
HOMEPAGE="http://dbus.freedesktop.org/"
#SRC_URI="http://dbus.freedesktop.org/releases/dbus/${P}.tar.gz"
SRC_URI=
EGIT_REPO_URI=git://review.tizen.org/platform/upstream/dbus.git
EGIT_BRANCH=kdbus-dev
