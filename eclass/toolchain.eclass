...
toolchain_src_configure() {
	...
	if is_crosscompile ; then
		# force disable systemtap, head on host gets detected then tries
		# to use target headers
		export glibcxx_cv_sys_sdt_h=no
...
gcc_do_filter_flags() {
	...
	filter-flags -fno-builtin-strcmp -fno-builtin-memcmp
