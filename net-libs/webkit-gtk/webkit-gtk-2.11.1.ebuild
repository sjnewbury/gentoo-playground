...
inherit cmake-utils check-reqs eutils flag-o-matic pax-utils python-any-r1 toolchain-funcs versionator virtualx
...
src_prepare() {
#	epatch "${FILESDIR}"/optional-glx-2.9.3.patch
#	epatch "${FILESDIR}"/${PN}-2.7.4-mutexlocker.patch
